...
tagList(
  reactable(
    ...
    columns = list(
      ...
      st           = colDef(name = "State",        maxWidth =  90),
      zip          = colDef(name = "ZIP",          maxWidth =  70),
      office_type  = colDef(name = "Office Type",  maxWidth = 130),
...
[^5]:
Hawaii's two Farm Credit branches are included...you just have to zoom out to find them. I did not find any Alaskan branches on the Farm Credit lender directory.