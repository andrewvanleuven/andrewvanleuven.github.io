...
**GitHub Link**: [`https://github.com/andrewvanleuven/andrewvanleuven.github.io/blob/main/aaea_webinar/demo_script.R`](https://github.com/andrewvanleuven/andrewvanleuven.github.io/blob/main/aaea_webinar/demo_script.R){style="font-size: 0.5em;"}
...
pal <- brewer.pal(length(brks), "YlGn")
```
...
left_map <- maplibre(bounds = states_sf, style = carto_style("voyager")) %>%
  ...
  add_continuous_legend("Corn Acres Planted, 2015",
    values = brks, colors = pal, position = "top-left")
...
## More Examples of Spatial Data Visualization in R

![](img/SCR-20260604-hdqy.png){fig-align="center" height="800px"}

## More Examples of Spatial Data Visualization in R

![](img/SCR-20260604-heiw.png){fig-align="center" height="800px"}

## More Examples of Spatial Data Visualization in R

![](img/SCR-20260604-hevo.png){fig-align="center" height="800px"}

## More Examples of Spatial Data Visualization in R

![](img/SCR-20260604-hfgl.jpeg){fig-align="center" height="800px"}
