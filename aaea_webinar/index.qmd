...
format:
  revealjs:
    ...
    footer: "Introduction to Maps | Andrew Van Leuven | UVM"
    incremental: false
    width: 1600
    height: 1000
...
::: {.notes}
One example worth showing: censusdots.com -- a national dot density map where every dot is one person, colored by race/ethnicity. Centered on Tulsa but you can pan anywhere. https://www.censusdots.com/?map=12.01263869294279,36.1714,-95.9200
:::
...
[censusdots.com](https://www.censusdots.com/?map=12.01263869294279,36.1714,-95.9200) — every dot is one person, colored by race/ethnicity

One of the most powerful examples of what spatial data can show that a table never could.
...
maplibre(style = carto_style("positron"),
  ...
  add_heatmap_layer(
    id = "heatmap", source = iowa_pts, heatmap_radius = 25,
